...
git clone https://github.com/splent-io/diversolab_app.git
```
...
```bash
splent product:select diversolab_app
...
When it finishes the app is served at <http://localhost:5125>, and
